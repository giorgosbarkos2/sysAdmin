...
(function($) {
    ...
    $.fn.fileUploader = function(config) {
        ...
        config = $.extend({}, {
            ...
            selectFileLabel: 'Selecccion archivos',
            allowedExtension: 'jpg|jpeg|gif|png|xls|doc|docx|xlsx|pdf',
            ...
            }, //trigger after the submit button is click: before upload
            beforeEachUpload: function() {
            }, //callback before each file has been uploaded ::: returns each Form
            afterUpload: function() {
            },
            afterEachUpload: function() {
            } //callback after each file has been uploaded
